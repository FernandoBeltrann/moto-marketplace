...
// Contenido tomado del prototipo de referencia (artifact de Diego). Los
// campos "pending" son notas de copy que el propio prototipo marcaba como
// pendiente de confirmar con FINVA/marketing — se muestran como tag ámbar
// arriba de la respuesta para que se puedan resolver antes de publicar.
const SELECCIONA_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    pending:
      'Falta completar esta guía con el cilindraje exacto (cc) de cada modelo, dato que solo aparece en la ficha individual de cada moto, no en el catálogo general.',
  },
  {
    id: 'bajaj-vs-yamaha',
    ...
    pending:
      'Tema renombrado: la versión original comparaba tres marcas incluyendo QJMotor, pero ese fabricante no tiene ningún modelo enfocado a trabajo en el catálogo actual.',
  },
  {
    id: 'rinde-gasolina',
    ...
    pending:
      'GAP REAL — no existe un dato de rendimiento (km/l) publicado en el sitio para ningún modelo. No se puede nombrar cuál rinde más en cifras hasta conseguir ese dato.',
  },
  {
...
const APLICA_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    pending: 'PENDIENTE — el formato exacto de la mención en el sitio de Yamaha todavía se está definiendo.',
  },
  {
    id: 'datos-seguros',
    question: '¿Es seguro compartir mis datos personales con MotoClick?',
    answer:
      'Tus datos los usa FINVA únicamente para evaluar tu perfil crediticio, y solo se comparten con la financiera a la que te referimos, para que te acepten en su sistema. No se comparten con nadie más. Es muy importante completar todo el proceso de aplicación: puedes revisar nuestro aviso de privacidad, nuestros testimoniales, y confirmar que FINVA es una empresa constituida legalmente bajo las leyes mexicanas.',
    pending: 'PENDIENTE — falta el enlace real al aviso de privacidad para poder ligarlo aquí.',
  },
  {
  ...
  return (
    <main className="section">
      <div className="container" style={{ maxWidth: 720 }}>
        ...
        <p>
          De elegir tu moto a tenerla en tus manos, en 4 pasos. Toca cada uno para ver el video y las preguntas
          de esa etapa. Financiamiento gestionado por Finva.
        </p>
          ...
          panels={{
            selecciona: (
              <>
                ...
                <p>
                  Explora el catálogo de Motoclick por marca, cilindraje y presupuesto. Cada ficha muestra
                  precio, mensualidad estimada y enganche sugerido para que compares antes de decidir cuál te
                  conviene.
                </p>
            ...
            aplica: (
              <>
                ...
                <p>
                  Una vez que elegiste tu moto, inicia tu solicitud de crédito directamente desde su ficha. Vas
                  a necesitar tus datos personales, domicilio, e información financiera y laboral básica para
                  que Finva pueda evaluar tu caso.
                </p>
            ...
            aprueba: (
              <>
                ...
                <p>
                  Con tu solicitud completa, Finva continúa la evaluación: revisa la información proporcionada,
                  confirma los documentos necesarios y te notifica el resultado de la aprobación junto con las
                  condiciones finales de tu crédito (enganche y mensualidad).
                </p>
            ...
            estrena: (
              <>
                ...
                <p>
                  Una vez aprobado tu crédito, se formaliza el contrato y se coordina la entrega de tu moto. A
                  partir de ahí, la unidad es tuya para que empieces a usarla.
                </p>
